...
lnt.open purpose_7.lnt generator -rename tgv.rename purpose_7.bcg


#echo
#echo "compute complete test graph"
bcg_open full_graph.bcg $TESTOR_DIR/bin.$ARCH/testor.a -total -io label.io purpose_7.bcg tc.bcg