...
lnt.open purpose_0.lnt generator -rename tgv.rename purpose_0.bcg


#echo
#echo "compute complete test graph"
bcg_open full_graph.bcg $TESTOR_DIR/bin.$ARCH/testor.a -total -io label.io purpose_0.bcg tc.bcg