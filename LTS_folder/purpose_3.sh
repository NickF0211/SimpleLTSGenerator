...
lnt.open purpose_3.lnt generator -rename tgv.rename purpose_3.bcg


#echo
#echo "compute complete test graph"
bcg_open full_graph.bcg $TESTOR_DIR/bin.$ARCH/testor.a -total -io label.io purpose_3.bcg tc.bcg