...
lnt.open purpose_4.lnt generator -rename tgv.rename purpose_4.bcg


#echo
#echo "compute complete test graph"
bcg_open full_graph.bcg $TESTOR_DIR/bin.$ARCH/testor.a -total -io label.io purpose_4.bcg tc.bcg